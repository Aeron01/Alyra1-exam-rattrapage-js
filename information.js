...
const information = (lastName, firstName, age, sex) => {
  ...
  switch (sex) {
    case ('M'):
      if (age < maj) {
        return console.log(`Monsieur, vous serez majeur dans ${maj - age} ans`)
      } else {
    ...
    case ('F'):
      if (age < maj) {
        return console.log(`Madame, vous serez majeur dans ${maj - age} ans`)
      } else {
    ...
    case ('?'):
      if (age < maj) {
        return console.log(`Vous serez majeur dans ${maj - age} ans`)
      } else {
